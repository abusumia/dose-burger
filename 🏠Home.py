...
database:dict = load_database(r"menu\meat_burger.json")
...
database:dict = load_database(r"menu\chicken_burger.json")
...
database_chili:dict = load_database(r"menu\chili_fries.json")
...
database_chili:dict = load_database(r"menu\salads.json")
imageCarouselComponent_fries = components.declare_component("image-carousel-component", path="frontend/public")
for q in database_chili["items"]:
    imageUrls_fries.append(q["img"])
...
database_healthy:dict = load_database(r"menu\healthy.json")
...
database_healthy:dict = load_database(r"menu\apigers.json")
imageCarouselComponent_healthy = components.declare_component("image-carousel-component", path="frontend/public")
for q in database_healthy["items"]:
    imageUrls_health.append(q["img"])
...
database_healthy:dict = load_database(r"menu\adds.json")
imageCarouselComponent_healthy = components.declare_component("image-carousel-component", path="frontend/public")
for q in database_healthy["items"]:
    imageUrls_health.append(q["img"])
...
database_healthy:dict = load_database(r"menu\drinks.json")
imageCarouselComponent_healthy = components.declare_component("image-carousel-component", path="frontend/public")
for q in database_healthy["items"]:
    imageUrls_health.append(q["img"])
...
database_healthy:dict = load_database(r"menu\sauces.json")
imageCarouselComponent_healthy = components.declare_component("image-carousel-component", path="frontend/public")
for q in database_healthy["items"]:
    imageUrls_health.append(q["img"])
